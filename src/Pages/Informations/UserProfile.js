        ...
        <>
            <div className='px-5 flex flex-col pt-40 md:pt-60 lg:justify-center items-center bg-base-100 overflow-x-hidden md:px-10 md:py-0 lg:h-screen lg:pt-0 md:w-full h-full'>
                <motion.div ref={ref}
                    ...
                    <div className='md:w-3/5 text-xs md:text-lg py-6 md:pl-10 text-base-content'>

                        <div className='flex w-fit h-fit items-center'>
                            <h1 className="text-2xl md:text-3xl lg:text-6xl font-bold lg:mb-2">{userFromDb?.displayName}</h1>
                            {
                                (userFromDb?.verification === "verified") && <FontAwesomeIcon className='text-blue-600  ml-1 mb-auto h-4 w-4 md:ml-4 md:h-8 md:w-8' icon={faCircleCheck} />
                            }
                        </div>
                    ...
                    <motion.div initial="hidden" animate={`${inView && "animate"}`} variants={{
                        ...
                        className='drop-shadow-2xl rounded-full md:w-2/5 md:max-w-sm md:h-full md:rounded-3xl md:absolute md:-right-5 lg:max-w-xl group '>
                        <img
