...
import { faAt, faIdCard, faGraduationCap, faBuildingColumns, faCircleCheck, faImages, faUserPen } from '@fortawesome/free-solid-svg-icons';
            ...
            <div className='px-5 flex flex-col pt-40 md:pt-60 xl:justify-center items-center bg-base-100 overflow-x-hidden md:px-10 md:py-0 md:w-full xl:h-screen xl:pt-0 h-full'>
                <motion.div ref={ref}
                    ...
                    <motion.div initial="hidden" animate={`${inView && "animate"}`} variants={{
                        ...
                        className='drop-shadow-2xl rounded-full md:w-1/3 md:max-w-full md:h-full md:rounded-3xl md:absolute md:-right-5 xl:max-w-xl flex items-center group '>
                        <img
