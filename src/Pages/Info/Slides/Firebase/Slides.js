                ...
                semesters.map((semester, i) => (
                    <div key={i} className='mt-5'>
                        <button
                            ...
                            className='border p-3 w-full btn btn-outline btn-primary capitalize'>
                            {semester.semester}
                                    ...
                                    <div key={ci} className={`transition-all flex flex-col justify-center items-center my-2`}>
                                        ...
                                        <div className='w-full'>
                                            ...
                                            <div className={`${courseCheck?.[`slide${ci}`] || "hidden"} flex flex-col justify-center items-center w-full bg-base-300 p-5`}>
                                                            ...
                                                            <div key={slideI} className=''>
                                                                {/* <embed className='embed' src={slide} type="" /> */}
                                                                {
                                                                    slide.toLowerCase().includes("pdf")
                                                                        ...
                                                                        : <iframe src='https://docs.google.com/presentation/d/1Bs3SxYjgNqq-40jVy1_01uMJJqA4KEoT/edit#slide=id.p1' width='100%' className='react-pdf__Page__canvas' title="fds">This is an embedded document, powered by</iframe>
                                                                }
                                                                {/* <Document file={slide} >
                                                                    <Page pageNumber={1} />
                                                ...
                                                <input onChange={(e) => handleUpload(e, semester.semester, course.courseName)}
