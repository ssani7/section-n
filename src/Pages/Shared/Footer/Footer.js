...
const Footer = () => {
    return (
        <div className='w-full h-auto'>
            ...
            <footer className="footer justify-center md:justify-between px-10 py-4 border-t bg-base-300 text-base-content border-base-300">
                <div className="items-center grid-flow-col justify-self-center md:justify-self-start">
                    ...
                    <div>
                        ...
                        <p className='text-base font-semibold'><a href="https://sanaullahsani.netlify.app/" target="_blank" className='link link-hover' rel="noreferrer">Sanaullah Sani</a></p>
                    </div>
                </div>
                <div>
                    <p className='text-2xs md:text-sm text-center'>Copyright © 2022 - All right reserved by Section: N <br /> Daffodil International University</p>
                </div>
                <div className="justify-self-center md:place-self-center md:justify-self-end">
                    <div className="flex flex-col md:flex-row items-center">
                        ...
                        <div>
                            <a target='_blank' href="https://t.me/+Hj8kt91NQRxjMWZl" rel="noreferrer"><FontAwesomeIcon className='w-10 h-8' icon={faTelegram}></FontAwesomeIcon></a>
                        </div>
                    </div>
                </div>
            </footer>
