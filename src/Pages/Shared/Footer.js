        ...
        <>
            <footer className="footer grid-cols-3 p-10 bg-base-200 text-base-content mt-16">
                ...
                <div className='w-fit mx-auto'>
                    ...
                    <a className="link link-hover">Contact CR</a>
                </div>
                <div className='w-fit mx-auto'>
            ...
            <footer className="footer justify-between px-10 py-4 border-t bg-base-300 text-base-content border-base-300">
                ...
                <div>
                    <p className='text-center'>Copyright © 2022 - All right reserved by Section: N, Daffodil International University</p>
                </div>
